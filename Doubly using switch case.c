...
displayfor()
{
    ...
    if(temp==NULL)
    {
        printf("There is nothing to show. Please create first.\n");
    }
    else
    {
        if(temp->next==NULL)
...
count()
{
    ...
    if(start==NULL)
    {
        printf("There is no nodes. Please create first.\n");
    }
    else
    {
        if(temp->next==NULL)
...
int f_search(int a)
{
    ...
    if(start==NULL)
    {
        printf("There is no linked list. Please create first.\n");
    }
    else
    {
    if(temp->next==NULL)
...
f_delete()
{
    ...
    if(start==NULL)
    {
    printf("Nothing to Delete. Please create first.\n");
    }
    else
    {
    while(count->next!=NULL)
...
opt()
{
    ...
    switch(G)
    {
        ...
        case 8:
            if(start==NULL)
            {
            printf("Nothing to search. Please create first.");
            }
            else
            {
